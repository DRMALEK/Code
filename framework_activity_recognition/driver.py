##############################################################################################################
# This file contains the main driver functions for training and testing the model
# The train function trains the model based on the configuration file
# The test_benchmark function tests the model based on the configuration file
# The load_state_dictionary function loads the pretrained model based on the architecture name
# The replace_last_layer function replaces the last layer of the architecture with the new one based on the configuration file 
##############################################################################################################
