...
def conv_bn(inp, oup, stride):
    """
        Returns a sequence of Conv3d, BatchNorm3d and ReLU layers.
    """
...
def get_fine_tuning_parameters(model, ft_portion):
    """
    Returns the parameters that need to be fine-tuned.

    Args: 
        model: The model to be fine-tuned.
        ft_portion: The portion of the model that needs to be fine-tuned. It can be 'complete' or 'last_layer'.     
    """
...
if __name__ == '__main__':
    ...
    model = nn.DataParallel(model, device_ids=None) # Use multiple GPUs
    print(model) 
