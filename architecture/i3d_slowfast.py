...
from i3d_resnet50_helpers import resnet_helper, stem_helper, head_helper, init_helper
from i3d_resnet50_helpers.batchnorm_helper import get_norm
import yaml
import torch
...
## LOGIT VERSION OF THE MODEL FOR THE PURPOSE OF KNOWLEDGE DISTILLATION
    ...
    def _construct_network(self, cfg):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            self.head = head_helper.ResNetBasicHead(
                ...
                dropout_rate=cfg.MODEL.DROPOUT_RATE,
                act_func="none",  # in normal cases this is should be equal to cfg.MODEL.HEAD_ACT
                detach_final_fc=cfg.MODEL.DETACH_FINAL_FC,
                cfg=cfg,
            )
...
if __name__== '__main__':
    ...
    #config = config.get_cfg()  # get the default config
    #config.merge_from_file("/home/malek/Master Thesis/SLOWFAST_8x8_R50.yaml")
    #model = get_model(cfg=config)

    #checkpoint = torch.load("/home/malek/Master Thesis/SLOWFAST_8x8_R50_MECCANO.pyth", map_location='cpu')
    #model.load_state_dict(checkpoint['model_state'])
    #print(model)